...
#|label: map-oysters
# Display oyster map
tmap_save(tm = oyster_results$map, here("figures", "oyster_map.pdf"))
```

![Oyster Suitability Map](figures/oyster_map.pdf)

```{r,echo=FALSE,message=FALSE}
#|label: map-scallops
# Display scallop map
tmap_save(tm = scallop_results$map, here("figures", "scallop_map.pdf"))
```

![Scallop Suitability Map](figures/scallop_map.pdf)
